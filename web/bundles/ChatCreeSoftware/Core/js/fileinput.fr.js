...
(function ($) {
    ...
    $.fn.fileinputLocales['fr'] = {
        ...
        msgSizeTooSmall: 'Le fichier "{name}" (<b>{size} KB</b>) est trop petit et doit faire plus de <b>{minSize} Ko</b>.',
        ...
        msgInvalidFileName: 'Caractères invalides ou non supportés dans le nom "{name}".',
        ...
        msgUploadThreshold: 'Traitement...',
        msgUploadBegin: 'Initialisation...',
        msgUploadEnd: 'Transféré',
