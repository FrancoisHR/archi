...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'bordereaux.services.bordereaulistener' => 'getBordereaux_Services_BordereaulistenerService',
            'bordereaux.services.devislistener' => 'getBordereaux_Services_DevislistenerService',
            'bordereaux.services.interfacelistener' => 'getBordereaux_Services_InterfacelistenerService',
            'bordereaux.services.pdfgenerator' => 'getBordereaux_Services_PdfgeneratorService',
            ...
            'chatcreesoftware.core.exception_listener' => 'getChatcreesoftware_Core_ExceptionListenerService',
            'chatcreesoftware.core.filenotification' => 'getChatcreesoftware_Core_FilenotificationService',
            'chatcreesoftware.core.teamnotification' => 'getChatcreesoftware_Core_TeamnotificationService',
            'chatcreesoftware.core.user_checker' => 'getChatcreesoftware_Core_UserCheckerService',
            'config_cache_factory' => 'getConfigCacheFactoryService',
            'controller_name_converter' => 'getControllerNameConverterService',
            'core.security.login_audit' => 'getCore_Security_LoginAuditService',
            'core.services.interfacelistener' => 'getCore_Services_InterfacelistenerService',
            'core.services.projectlistener' => 'getCore_Services_ProjectlistenerService',
            'core.services.userlistener' => 'getCore_Services_UserlistenerService',
            ...
            'fileserver.services.interfacelistener' => 'getFileserver_Services_InterfacelistenerService',
            ...
            'projectmanagement.services.interfacelistener' => 'getProjectmanagement_Services_InterfacelistenerService',
            ...
            'security.firewall.map.context.fileserver' => 'getSecurity_Firewall_Map_Context_FileserverService',
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\ConfigurationResource(array('jquery_and_ui' => array(0 => array(0 => 'bundles/ChatCreeSoftware/Core/js/jquery-3.1.1.min.js', 1 => 'bundles/ChatCreeSoftware/Core/js/jquery-migrate-3.0.0.min.js', 2 => 'bundles/ChatCreeSoftware/Core/js/jquery-ui.min.js'), 1 => array(), 2 => array()), 'bootstrap_and_datatables' => array(0 => array(0 => 'bundles/ChatCreeSoftware/Core/js/jquery.autocomplete.js', 1 => 'bundles/ChatCreeSoftware/Core/js/jquery.ui.datepicker-fr.js', 2 => 'bundles/ChatCreeSoftware/Core/bootstrap/js/bootstrap.min.js', 3 => 'bundles/ChatCreeSoftware/Core/js/jquery.bootstrap.min.js', 4 => 'bundles/ChatCreeSoftware/Core/js/datatables.min.js', 5 => 'bundles/ChatCreeSoftware/Core/js/dataTables.bootstrap.min.js', 6 => 'bundles/ChatCreeSoftware/Core/js/buttons.bootstrap.min.js', 7 => 'bundles/ChatCreeSoftware/Core/js/datatables.date-euro.js', 8 => 'bundles/ChatCreeSoftware/Core/js/datatables.num-list.js', 9 => 'bundles/ChatCreeSoftware/Core/js/sprintf.js'), 1 => array(), 2 => array()))), 'config');
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'CoreBundle', ($this->targetDirs[3].'/app/Resources/CoreBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'CoreBundle', ($this->targetDirs[3].'/src/ChatCreeSoftware/CoreBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'BordereauxBundle', ($this->targetDirs[3].'/app/Resources/BordereauxBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'BordereauxBundle', ($this->targetDirs[3].'/src/ChatCreeSoftware/BordereauxBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'FileserverBundle', ($this->targetDirs[3].'/app/Resources/FileserverBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'FileserverBundle', ($this->targetDirs[3].'/src/ChatCreeSoftware/FileserverBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'ProjectManagementBundle', ($this->targetDirs[3].'/app/Resources/ProjectManagementBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'ProjectManagementBundle', ($this->targetDirs[3].'/src/ChatCreeSoftware/ProjectManagementBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    {
        return $this->services['assetic.filter_manager'] = new \Symfony\Bundle\AsseticBundle\FilterManager($this, array('cssrewrite' => 'assetic.filter.cssrewrite', 'uglifycss' => 'assetic.filter.uglifycss', 'uglifyjs2' => 'assetic.filter.uglifyjs2'));
    }
    ...
    /**
     * Gets the 'bordereaux.services.bordereaulistener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \ChatCreeSoftware\BordereauxBundle\Listener\BordereauListener A ChatCreeSoftware\BordereauxBundle\Listener\BordereauListener instance
     */
    protected function getBordereaux_Services_BordereaulistenerService()
    {
        return $this->services['bordereaux.services.bordereaulistener'] = new \ChatCreeSoftware\BordereauxBundle\Listener\BordereauListener($this->get('security.acl.provider'), $this->get('security.token_storage'));
    }

    /**
     * Gets the 'bordereaux.services.devislistener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \ChatCreeSoftware\BordereauxBundle\Listener\DevisListener A ChatCreeSoftware\BordereauxBundle\Listener\DevisListener instance
     */
    protected function getBordereaux_Services_DevislistenerService()
    {
        return $this->services['bordereaux.services.devislistener'] = new \ChatCreeSoftware\BordereauxBundle\Listener\DevisListener($this->get('security.acl.provider'), $this->get('security.token_storage'));
    }

    /**
     * Gets the 'bordereaux.services.interfacelistener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \ChatCreeSoftware\BordereauxBundle\Listener\InterfaceListener A ChatCreeSoftware\BordereauxBundle\Listener\InterfaceListener instance
     */
    protected function getBordereaux_Services_InterfacelistenerService()
    {
        return $this->services['bordereaux.services.interfacelistener'] = new \ChatCreeSoftware\BordereauxBundle\Listener\InterfaceListener($this->get('doctrine.orm.default_entity_manager'), $this->get('security.acl.provider'), $this->get('security.authorization_checker'), $this->get('router'));
    }

    /**
     * Gets the 'bordereaux.services.pdfgenerator' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \ChatCreeSoftware\BordereauxBundle\Services\PdfGenerator A ChatCreeSoftware\BordereauxBundle\Services\PdfGenerator instance
     */
    protected function getBordereaux_Services_PdfgeneratorService()
    {
        return $this->services['bordereaux.services.pdfgenerator'] = new \ChatCreeSoftware\BordereauxBundle\Services\PdfGenerator($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('te6Sus6k58', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('vdh7io5Ygm', 0, '1lbqwFPyQjLQFIinCkYqZy', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        return $this->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(array(0 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplatePathsCacheWarmer($c, ${($_ = isset($this->services['templating.locator']) ? $this->services['templating.locator'] : $this->getTemplating_LocatorService()) && false ?: '_'}), 1 => new \Symfony\Bundle\AsseticBundle\CacheWarmer\AssetManagerCacheWarmer($this), 2 => $this->get('kernel.class_cache.cache_warmer'), 3 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TranslationsCacheWarmer($this->get('translator.default')), 4 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\ValidatorCacheWarmer($this->get('validator.builder'), (__DIR__.'/validation.php'), \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('hL+GSORNM3', 0, '1lbqwFPyQjLQFIinCkYqZy', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE))), 5 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\RouterCacheWarmer($this->get('router')), 6 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\AnnotationsCacheWarmer(${($_ = isset($this->services['annotations.reader']) ? $this->services['annotations.reader'] : $this->getAnnotations_ReaderService()) && false ?: '_'}, (__DIR__.'/annotations.php'), ${($_ = isset($this->services['cache.annotations']) ? $this->services['cache.annotations'] : $this->getCache_AnnotationsService()) && false ?: '_'}), 7 => new \Symfony\Bundle\TwigBundle\CacheWarmer\TemplateCacheCacheWarmer($this, $c, array()), 8 => new \Symfony\Bundle\TwigBundle\CacheWarmer\TemplateCacheWarmer($this->get('twig'), new \Symfony\Bundle\TwigBundle\TemplateIterator($a, ($this->targetDirs[3].'/app'), array())), 9 => new \Symfony\Bridge\Doctrine\CacheWarmer\ProxyCacheWarmer($this->get('doctrine'))));
    }

    /**
     * Gets the 'chatcreesoftware.core.exception_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \ChatCreeSoftware\CoreBundle\Listener\ExceptionListener A ChatCreeSoftware\CoreBundle\Listener\ExceptionListener instance
     */
    protected function getChatcreesoftware_Core_ExceptionListenerService()
    {
        return $this->services['chatcreesoftware.core.exception_listener'] = new \ChatCreeSoftware\CoreBundle\Listener\ExceptionListener($this->get('templating'), $this->get('kernel'));
    }

    /**
     * Gets the 'chatcreesoftware.core.filenotification' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \ChatCreeSoftware\CoreBundle\Services\FileNotification A ChatCreeSoftware\CoreBundle\Services\FileNotification instance
     */
    protected function getChatcreesoftware_Core_FilenotificationService()
    {
        return $this->services['chatcreesoftware.core.filenotification'] = new \ChatCreeSoftware\CoreBundle\Services\FileNotification($this->get('doctrine.orm.default_entity_manager'), $this->get('swiftmailer.mailer.default'), $this->get('security.acl.provider'), $this->get('twig'));
    }

    /**
     * Gets the 'chatcreesoftware.core.teamnotification' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \ChatCreeSoftware\CoreBundle\Services\TeamNotification A ChatCreeSoftware\CoreBundle\Services\TeamNotification instance
     */
    protected function getChatcreesoftware_Core_TeamnotificationService()
    {
        return $this->services['chatcreesoftware.core.teamnotification'] = new \ChatCreeSoftware\CoreBundle\Services\TeamNotification($this->get('doctrine.orm.default_entity_manager'), $this->get('swiftmailer.mailer.default'), $this->get('security.acl.provider'), $this->get('twig'));
    }

    /**
     * Gets the 'chatcreesoftware.core.user_checker' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \ChatCreeSoftware\CoreBundle\Security\Authorization\UserChecker A ChatCreeSoftware\CoreBundle\Security\Authorization\UserChecker instance
     */
    protected function getChatcreesoftware_Core_UserCheckerService()
    {
        return $this->services['chatcreesoftware.core.user_checker'] = new \ChatCreeSoftware\CoreBundle\Security\Authorization\UserChecker();
    }
    ...
    /**
     * Gets the 'core.security.login_audit' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \ChatCreeSoftware\CoreBundle\Security\Authorization\LoginAudit A ChatCreeSoftware\CoreBundle\Security\Authorization\LoginAudit instance
     */
    protected function getCore_Security_LoginAuditService()
    {
        return $this->services['core.security.login_audit'] = new \ChatCreeSoftware\CoreBundle\Security\Authorization\LoginAudit($this->get('doctrine.orm.default_entity_manager'), $this->get('templating'), $this->get('router'), 'projets/liste');
    }

    /**
     * Gets the 'core.services.interfacelistener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \ChatCreeSoftware\CoreBundle\Listener\InterfaceListener A ChatCreeSoftware\CoreBundle\Listener\InterfaceListener instance
     */
    protected function getCore_Services_InterfacelistenerService()
    {
        return $this->services['core.services.interfacelistener'] = new \ChatCreeSoftware\CoreBundle\Listener\InterfaceListener($this->get('doctrine.orm.default_entity_manager'), $this->get('security.acl.provider'), $this->get('security.authorization_checker'), $this->get('router'));
    }

    /**
     * Gets the 'core.services.projectlistener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \ChatCreeSoftware\CoreBundle\Listener\ProjectListener A ChatCreeSoftware\CoreBundle\Listener\ProjectListener instance
     */
    protected function getCore_Services_ProjectlistenerService()
    {
        return $this->services['core.services.projectlistener'] = new \ChatCreeSoftware\CoreBundle\Listener\ProjectListener($this->get('security.acl.provider'), $this->get('security.token_storage'));
    }

    /**
     * Gets the 'core.services.userlistener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \ChatCreeSoftware\CoreBundle\Listener\UserListener A ChatCreeSoftware\CoreBundle\Listener\UserListener instance
     */
    protected function getCore_Services_UserlistenerService()
    {
        return $this->services['core.services.userlistener'] = new \ChatCreeSoftware\CoreBundle\Listener\UserListener($this->get('security.acl.provider'));
    }
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListenerService('kernel.exception', array(0 => 'chatcreesoftware.core.exception_listener', 1 => 'onKernelException'), 0);
        ...
        $instance->addSubscriberService('core.services.interfacelistener', 'ChatCreeSoftware\\CoreBundle\\Listener\\InterfaceListener');
        $instance->addSubscriberService('bordereaux.services.interfacelistener', 'ChatCreeSoftware\\BordereauxBundle\\Listener\\InterfaceListener');
        $instance->addSubscriberService('fileserver.services.interfacelistener', 'ChatCreeSoftware\\FileserverBundle\\Listener\\InterfaceListener');
        $instance->addSubscriberService('projectmanagement.services.interfacelistener', 'ChatCreeSoftware\\ProjectManagementBundle\\Listener\\InterfaceListener');
    ...
    protected function getDoctrine_Orm_DefaultEntityListenerResolverService()
    {
        ...
        $instance->registerService('ChatCreeSoftware\\CoreBundle\\Listener\\UserListener', 'core.services.userlistener');
        $instance->registerService('ChatCreeSoftware\\CoreBundle\\Listener\\ProjectListener', 'core.services.projectlistener');
        $instance->registerService('ChatCreeSoftware\\BordereauxBundle\\Listener\\BordereauListener', 'bordereaux.services.bordereaulistener');
        $instance->registerService('ChatCreeSoftware\\BordereauxBundle\\Listener\\DevisListener', 'bordereaux.services.devislistener');
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'/src/ChatCreeSoftware/CoreBundle/Resources/config/doctrine') => 'ChatCreeSoftware\\CoreBundle\\Entity', ($this->targetDirs[3].'/src/ChatCreeSoftware/BordereauxBundle/Resources/config/doctrine') => 'ChatCreeSoftware\\BordereauxBundle\\Entity', ($this->targetDirs[3].'/src/ChatCreeSoftware/FileserverBundle/Resources/config/doctrine') => 'ChatCreeSoftware\\FileserverBundle\\Entity', ($this->targetDirs[3].'/src/ChatCreeSoftware/ProjectManagementBundle/Resources/config/doctrine') => 'ChatCreeSoftware\\ProjectManagementBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'ChatCreeSoftware\\CoreBundle\\Entity');
        $b->addDriver($a, 'ChatCreeSoftware\\BordereauxBundle\\Entity');
        $b->addDriver($a, 'ChatCreeSoftware\\FileserverBundle\\Entity');
        $b->addDriver($a, 'ChatCreeSoftware\\ProjectManagementBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('CoreBundle' => 'ChatCreeSoftware\\CoreBundle\\Entity', 'BordereauxBundle' => 'ChatCreeSoftware\\BordereauxBundle\\Entity', 'FileserverBundle' => 'ChatCreeSoftware\\FileserverBundle\\Entity', 'ProjectManagementBundle' => 'ChatCreeSoftware\\ProjectManagementBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_48b05f24de42350847336dfd1bb3c4c455155e9ff8e3039e6e9715544a954a16');
    ...
    /**
     * Gets the 'fileserver.services.interfacelistener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \ChatCreeSoftware\FileserverBundle\Listener\InterfaceListener A ChatCreeSoftware\FileserverBundle\Listener\InterfaceListener instance
     */
    protected function getFileserver_Services_InterfacelistenerService()
    {
        return $this->services['fileserver.services.interfacelistener'] = new \ChatCreeSoftware\FileserverBundle\Listener\InterfaceListener($this->get('doctrine.orm.default_entity_manager'), $this->get('security.acl.provider'), $this->get('security.authorization_checker'), $this->get('router'));
    }
    ...
    /**
     * Gets the 'projectmanagement.services.interfacelistener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \ChatCreeSoftware\ProjectManagementBundle\Listener\InterfaceListener A ChatCreeSoftware\ProjectManagementBundle\Listener\InterfaceListener instance
     */
    protected function getProjectmanagement_Services_InterfacelistenerService()
    {
        return $this->services['projectmanagement.services.interfacelistener'] = new \ChatCreeSoftware\ProjectManagementBundle\Listener\InterfaceListener($this->get('doctrine.orm.default_entity_manager'), $this->get('security.acl.provider'), $this->get('security.authorization_checker'), $this->get('router'));
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('ChatCreeSoftware\\CoreBundle\\Entity\\User' => array('algorithm' => 'sha512', 'hash_algorithm' => 'sha512', 'key_length' => 40, 'ignore_case' => false, 'encode_as_base64' => true, 'iterations' => 5000, 'cost' => 13)));
    }
    ...
    /**
     * Gets the 'security.firewall.map.context.fileserver' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getSecurity_Firewall_Map_Context_FileserverService()
    {
        ...
        $f = $this->get('core.security.login_audit');
        ...
        $i = new \Symfony\Component\HttpFoundation\RequestMatcher('/reset/.*');

        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('/document/.*');

        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('/projets/.*');

        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('/gestion/.*');

        $m = new \Symfony\Component\HttpFoundation\RequestMatcher('/bordereaux/.*');
        ...
        $n->add($k, array(0 => 'ROLE_USER'), NULL);
        $n->add($l, array(0 => 'ROLE_EMPLOYEE'), NULL);
        $n->add($m, array(0 => 'ROLE_PROVIDER'), NULL);

        $o = new \Symfony\Component\Security\Http\HttpUtils($e, $e);

        $p = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $o, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($o, '/login'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => '/logout'));
        $p->addHandler(new \Symfony\Component\Security\Http\Logout\SessionLogoutHandler());

        return $this->services['security.firewall.map.context.fileserver'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($n, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => ${($_ = isset($this->services['security.user.provider.concrete.chain_provider']) ? $this->services['security.user.provider.concrete.chain_provider'] : $this->getSecurity_User_Provider_Concrete_ChainProviderService()) && false ?: '_'}, 1 => ${($_ = isset($this->services['security.user.provider.concrete.user_db']) ? $this->services['security.user.provider.concrete.user_db'] : $this->getSecurity_User_Provider_Concrete_UserDbService()) && false ?: '_'}), 'fileserver', $a, $c, $d), 2 => $p, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $g, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $o, 'fileserver', new \Symfony\Component\Security\Http\Authentication\CustomAuthenticationSuccessHandler($f, array('login_path' => '/login', 'default_target_path' => 'projets/liste', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false), 'fileserver'), new \Symfony\Component\Security\Http\Authentication\CustomAuthenticationFailureHandler($f, array('login_path' => '/login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path')), array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $a, $c, $this->get('security.csrf.token_manager')), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '58f8db81614141.75931952', $a, $g), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, ${($_ = isset($this->services['debug.security.access.decision_manager']) ? $this->services['debug.security.access.decision_manager'] : $this->getDebug_Security_Access_DecisionManagerService()) && false ?: '_'}, $n, $g)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $d, $o, 'fileserver', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($this->get('http_kernel'), $o, '/login', false), NULL, NULL, $a, false), new \Symfony\Bundle\SecurityBundle\Security\FirewallConfig('fileserver', 'ChatCreeSoftware.Core.user_checker', NULL, true, false, 'security.user.provider.concrete.chain_provider', 'fileserver', 'security.authentication.form_entry_point.fileserver', NULL, NULL, array(0 => 'logout', 1 => 'form_login', 2 => 'anonymous')));
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension(${($_ = isset($this->services['assetic.asset_factory']) ? $this->services['assetic.asset_factory'] : $this->getAssetic_AssetFactoryService()) && false ?: '_'}, $this->get('templating.name_parser'), true, array(), array(0 => 'FrameworkBundle', 1 => 'SecurityBundle', 2 => 'TwigBundle', 3 => 'MonologBundle', 4 => 'SwiftmailerBundle', 5 => 'AsseticBundle', 6 => 'DoctrineBundle', 7 => 'SensioFrameworkExtraBundle', 8 => 'CoreBundle', 9 => 'BordereauxBundle', 10 => 'FileserverBundle', 11 => 'ProjectManagementBundle', 12 => 'DebugBundle', 13 => 'WebProfilerBundle', 14 => 'SensioDistributionBundle', 15 => 'SensioGeneratorBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
        ...
        $instance->addGlobal('web_dir', ($this->targetDirs[3].'/app/../web'));
        $instance->addGlobal('lib_dir', ($this->targetDirs[3].'/app/../web/library'));
        $instance->addGlobal('projects_dir', ($this->targetDirs[3].'/app/../web/projects'));
        $instance->addGlobal('bordereaux_dir', '.bordereaux');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/ChatCreeSoftware/CoreBundle/Resources/views'), 'Core');
        $instance->addPath(($this->targetDirs[3].'/src/ChatCreeSoftware/BordereauxBundle/Resources/views'), 'Bordereaux');
        $instance->addPath(($this->targetDirs[3].'/src/ChatCreeSoftware/FileserverBundle/Resources/views'), 'Fileserver');
        $instance->addPath(($this->targetDirs[3].'/src/ChatCreeSoftware/ProjectManagementBundle/Resources/views'), 'ProjectManagement');
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('fdw1YTLQ21', 0, '1lbqwFPyQjLQFIinCkYqZy', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider(${($_ = isset($this->services['security.user.provider.concrete.chain_provider']) ? $this->services['security.user.provider.concrete.chain_provider'] : $this->getSecurity_User_Provider_Concrete_ChainProviderService()) && false ?: '_'}, $this->get('chatcreesoftware.core.user_checker'), 'fileserver', $this->get('security.encoder_factory'), true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('58f8db81614141.75931952')), true);
    ...
    {
        return $this->services['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.fileserver' => NULL));
    }
    ...
    protected function getSecurity_LogoutUrlGeneratorService()
    {
        ...
        $instance->registerListener('fileserver', '/logout', 'logout', '_csrf_token', NULL);
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_PROVIDER' => array(0 => 'ROLE_USER'), 'ROLE_EMPLOYEE' => array(0 => 'ROLE_PROVIDER'), 'ROLE_ADMIN' => array(0 => 'ROLE_EMPLOYEE', 1 => 'ROLE_PROVIDER', 2 => 'ROLE_ADMIN')));
    }
    ...
    {
        return $this->services['security.user.provider.concrete.user_db'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'ChatCreeSoftware\\CoreBundle\\Entity\\User', 'login', NULL);
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'CoreBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/ChatCreeSoftware/CoreBundle'),
                    'namespace' => 'ChatCreeSoftware\\CoreBundle',
                ),
                'BordereauxBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/ChatCreeSoftware/BordereauxBundle'),
                    'namespace' => 'ChatCreeSoftware\\BordereauxBundle',
                ),
                'FileserverBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/ChatCreeSoftware/FileserverBundle'),
                    'namespace' => 'ChatCreeSoftware\\FileserverBundle',
                ),
                'ProjectManagementBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/ChatCreeSoftware/ProjectManagementBundle'),
            ...
            case 'web_dir': $value = ($this->targetDirs[3].'/app/../web'); break;
            case 'lib_dir': $value = ($this->targetDirs[3].'/app/../web/library'); break;
            case 'projects_dir': $value = ($this->targetDirs[3].'/app/../web/projects'); break;
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'CoreBundle' => 'ChatCreeSoftware\\CoreBundle\\CoreBundle',
                'BordereauxBundle' => 'ChatCreeSoftware\\BordereauxBundle\\BordereauxBundle',
                'FileserverBundle' => 'ChatCreeSoftware\\FileserverBundle\\FileserverBundle',
                'ProjectManagementBundle' => 'ChatCreeSoftware\\ProjectManagementBundle\\ProjectManagementBundle',
            ...
            'default_target' => 'projets/liste',
            'bordereaux_dir' => '.bordereaux',
