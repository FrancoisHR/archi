...
class ProjectController extends Controller {
    ...
    public function projectAction(Request $request, UserInterface $user, Project $project, $foldername = null) {
        ...
        if (isset($foldername)) {
            ...
            if (!file_exists($project->getProjectPath() . $folderpath)) {
                mkdir($project->getProjectPath() . $folderpath, 0705 );
            }
        ...
        $uploadForm = $this->get('form.factory')
                ...
                ->add('attachment', 'Symfony\Component\Form\Extension\Core\Type\CheckboxType', array( 'required' => false ))
    ...
    /**
     * @Route("/projets/suppression_projet/{id}", name="_project_perform_delete", defaults={ "id"=0 } )
     * @Template
     */
